    ...
    public class SignInHelper
    {
        ...
        public async Task SignInAsync(ApplicationUser user, bool isPersistent, bool rememberBrowser)
        {
            ...
            if (rememberBrowser)
            {
                ...
                AuthenticationManager.SignIn(authenticationProperties, userIdentity, rememberBrowserIdentity);
            }
            else
            {
        ...
        public async Task<string> GetVerifiedUserIdAsync()
        {
            ...
            {
                if (!string.IsNullOrEmpty(result.Identity.GetUserId()))
                {
        ...
        private async Task<SignInStatus> SignInOrTwoFactor(ApplicationUser user, bool isPersistent)
        {
                ...
                !await AuthenticationManager.TwoFactorBrowserRememberedAsync(user.Id))
            {
                ...
                return SignInStatus.RequiresVerification; //return SignInStatus.RequiresTwoFactorAuthentication;
            }
